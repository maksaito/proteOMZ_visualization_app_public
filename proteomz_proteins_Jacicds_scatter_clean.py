...
PROTEOMZ_DATA_FILE = 'FINALdataset.csv'
...
# introduction text
INTRODUCTION_HTML = """<b>Ocean Proteomics data from <i>Falkor ProteOMZ Expedition</i> in January-February of 2015.
...
menus to enable scientific discovery within this novel dataset."""
INTRODUCTION_WIDTH = 380
INTRODUCTION_HEIGHT = 110
